  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={isGridView ? 'grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 justify-items-center' : 'flex justify-center items-center space-x-4 flex-wrap'}>
