        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              ...
              <a href="https://www.linkedin.com/in/helping-heart-family-rwanda-h-h-f-r-9a51572b2/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-100 transition-all">
