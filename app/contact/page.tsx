          ...
          <div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-lg">info@helpingheart.org.rw</p>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.linkedin.com/in/helping-heart-family-rwanda-h-h-f-r-9a51572b2" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition-all">
