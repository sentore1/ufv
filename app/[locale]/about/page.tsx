      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl">
            <Image src="/ufvimages/47.jpg" alt="Community work" fill className="object-cover" />
          </div>
          <div>
            <h2 className="text-5xl font-bold mb-8 text-gray-900">{t('ourMission')}</h2>
        ...
        <div className="bg-gradient-to-br from-green-800 to-green-900 rounded-3xl p-16 mb-32 text-center shadow-2xl">
          <h2 className="text-5xl font-bold mb-8 text-white">{t('ourVision')}</h2>
        ...
        <div className="mb-32">
          <h2 className="text-5xl font-bold mb-12 text-gray-900 text-center">{t('challengesTitle')}</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-10 rounded-3xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="font-bold text-2xl mb-4 text-gray-900">{t('poverty')}</h3>
              <p className="text-gray-600 text-lg leading-relaxed">{t('povertyDesc')}</p>
            </div>
            <div className="bg-gray-50 p-10 rounded-3xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-14 h-14 bg-green-700 rounded-xl flex items-center justify-center mb-6">
              ...
              <h3 className="font-bold text-2xl mb-4 text-gray-900">{t('emergency')}</h3>
              <p className="text-gray-600 text-lg leading-relaxed">{t('emergencyDesc')}</p>
            </div>
            <div className="bg-gray-50 p-10 rounded-3xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-14 h-14 bg-green-700 rounded-xl flex items-center justify-center mb-6">
              ...
              <h3 className="font-bold text-2xl mb-4 text-gray-900">{t('opportunities')}</h3>
              <p className="text-gray-600 text-lg leading-relaxed">{t('opportunitiesDesc')}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          <div>
            <h2 className="text-5xl font-bold mb-8 text-gray-900">{t('ourResponse')}</h2>
            <p className="text-xl text-gray-600 leading-relaxed mb-6">
              {t('responseText1')}
            </p>
          ...
          <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl">
            <Image src="/ufvimages/34.jpg" alt="Team work" fill className="object-cover" />
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-3xl p-16 mb-32">
          <h2 className="text-5xl font-bold mb-12 text-gray-900 text-center">{t('coreValues')}</h2>
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bold text-xl mb-3 text-gray-900">{t('integrity')}</h3>
              <p className="text-gray-600">{t('integrityDesc')}</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-green-700 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <h3 className="font-bold text-xl mb-3 text-gray-900">{t('compassion')}</h3>
              <p className="text-gray-600">{t('compassionDesc')}</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-green-700 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <h3 className="font-bold text-xl mb-3 text-gray-900">{t('community')}</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-xl mb-3 text-gray-900">{t('empowerment')}</h3>
              <p className="text-gray-600">{t('empowermentDesc')}</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-bold text-gray-900 mb-4">{t('ourPartners')}</h2>
