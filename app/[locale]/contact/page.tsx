    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[400px] bg-gradient-to-br from-green-600 via-green-700 to-green-800 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10">
          ...
          <p className="text-2xl text-white/95 max-w-3xl">We'd love to hear from you</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 mb-12">Reach out to us for any inquiries</p>
          ...
          <div className="bg-gray-50 p-12 rounded-3xl shadow-xl">
            <h3 className="text-3xl font-bold mb-8 text-gray-900">Send Message</h3>
